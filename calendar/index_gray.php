...
function popupEvent(day, monthID, yearID, w, h) {
	...
	win = location="http://www.seecs.nust.edu.pk/event_calendar/index.php?day=" + day + "&monthID=" + monthID + "&yearID=" + yearID + "","Calendar","scrollbars=yes, status=yes, location=yes, toolbar=yes, menubar=yes, directories=yes, resizable=yes, width=" + w + ", height=" + h + ", top=";
...
$QQ = sprintf("SELECT REPLACE(TRIM(REPLACE(title,'-','')),'NIIT','NUST-SEECS') as title,id,day,month,year,date FROM `events` WHERE `date` > '%s' AND `date` < '%s' AND `day` = '%s';", $tm, $tp, $list_day);
$RR = mysql_query($QQ);		
$title="";
...
//		if(date("Y/m/d",$D['date'])>'2010/04/15')
//		$TheDay=$TheDay+1;
		...
		if ($S) {
		?>
			<td align="center" onclick="popupEvent(<?php echo $D['day']; ?>, <?php echo $D['month']; ?>, <?php echo $D['year']; ?>, 400, 500)" style="background-color:#999999; color: #333333; cursor: pointer;" onmouseover="return overlib('&lt;table width=200;100%&quot; border=&quot;0&quot; cellpadding=&quot;2&quot; cellspacing=&quot;0&quot; class=&quot;popupDateTable&quot;&gt;&lt;tr&gt;&lt;td align=&quot;center&quot; class=&quot;popupDate&quot;&gt;<?php echo $TheDay; ?> <?php echo $TheMon; ?> <?php echo $TheYea; ?>&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;&lt;div class=&quot;popupEventTitle s23&quot;&gt;<?php echo $title; ?> &lt;/div&gt;');" onmouseout="return nd();" title="">
		<?php
		} elseif ($tn > $tm AND $tn < $tp AND date('j') == $list_day AND date('m') == $month AND date('Y') == $year) {
		?>
			<td align="center" style="background-color: #666666; color: #000000; cursor: pointer;" onmouseover="return overlib('&lt;div style=&quot;background-color: #666666; color: #000000; padding: 4px;&quot;&gt;Today&lt;/div&gt;');" onmouseout="return nd();">
		<?php

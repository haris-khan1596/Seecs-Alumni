...
function popupEvent(day, monthID, yearID, w, h) {
	...
	win = window.open("http://www.seecs.nust.edu.pk/event_calendar/index.php?day=" + day + "&monthID=" + monthID + "&yearID=" + yearID + "","Calendar");
...
//		$TheDay=$TheDay+1;
		...
		if ($S) {
		?>
			<td align="center" onclick="popupEvent(<?php echo $D['day']; ?>, <?php echo $D['month']; ?>, <?php echo $D['year']; ?>, 400, 500)" style="background-color: #FAC557; color: #333333; cursor: pointer;" onmouseover="return overlib('&lt;table border=&quot;0&quot; cellpadding=&quot;2&quot; cellspacing=&quot;0&quot; class=&quot;popupDateTable&quot;&gt;&lt;tr&gt;&lt;td align=&quot;center&quot; class=&quot;popupDate&quot;&gt;<?php echo $TheDay; ?> <?php echo $TheMon; ?> <?php echo $TheYea; ?>&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;&lt;div class=&quot;popupEventTitle s23&quot;&gt;<?php echo $title; ?> &lt;/div&gt;');" onmouseout="return nd();" title="">
		<?php

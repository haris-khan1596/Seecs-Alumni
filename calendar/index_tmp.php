...
function popupEvent(day, monthID, yearID, w, h) {
	...
	window.open ("http://www.seecs.nust.edu.pk/event_calendar/index.php?day=" + day + "&monthID=" + monthID + "&yearID=" + yearID + "","Calendar","scrollbars=yes, status=yes, location=yes, toolbar=yes, menubar=yes, directories=yes, resizable=yes, width=" + w + ", height=" + h + ",target=_new, top=")

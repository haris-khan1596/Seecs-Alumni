    ...
    <td align="left" valign="top"><table border="0" align="center" cellpadding="3" cellspacing="0" class="table_body">
      <tr>
        <td height="323" valign="top">
         ...
         <?php if($_GET['email_err']=="0") { ?>		
            <div class="msgbox_green">Your request for Registration Number has been sent to the Alumni Relations Office. You shall soon receive your registration number on the email address provided by you.</div>
		<?php }	?>
		...
		<?php } ?>
     	...
     	<?php if($_GET['err_reg_no']==1) { ?>		
            <div class="msgbox_red">The Registration No you entered is invalid. Please try again</div>
		<?php } ?>
...
<td width="597"><p class="img_heading">Alumni Registration Request Form     
    <br>
    <span class="b_text">* Fields are compulsory</span><br>
* <span class="b_text">If you forgot your Registration No. You can request from <a href="get_reg_no.php" target="_parent"> here </a>
...
<tr >
  ...
  <tr >
    ...
    <div align="left" style="width:350px"><span class="b_text">
      <select name="txtreg1" class="b_text" id="txtreg1" onBlur="getregno()">
...
?>
    ...
    <input name="txtreg4" type="text" class="b_text" id="txtreg4" size="3" maxlength="3" onBlur="chknum(frmregister.txtreg4)" value="<?php echo $_SESSION['form']['txtreg4']; ?>" onChange="getregno()" /> <a href="get_reg_no.php" target="_parent"> forgot ? </a>
     
</span> 
</div>

<span id="div_reg_user_chk" style="width:250px" > </span> 
  ...
  <tr >
	...
	<input name="txtname" type="text"  id="txtname" size="34" value="<?php echo $_SESSION['form']['txtname'] ?>" onFocus="getregno()">	</td>
  </tr>
  <tr >
    <td width="30%" class="b_text">Father's Name*</td>
    <td width="70%" align="left" valign="top" class="fbinput"><input name="txtfname" type="text"  id="txtfname" size="34" value="<?php echo $_SESSION['form']['txtfname'] ?>" ></td>
  </tr>
  <tr >
...
?></td>
  ...
  <tr >
    ...
    <td width="70%" align="left" valign="top" class="fbinput"><input name="txtemail" type="text"  id="txtemail" size="34" onBlur="auto_user_name()" value="<?php echo $_SESSION['form']['txtemail'] ?>" onFocus="getregno()"></td>
  </tr>
   <tr  class="b_text">
  ...
  <tr  class="b_text">
    ...
    <td width="70%" class="fbinput"><input name="txtre_enter" type="password"  id="txtre_enter" size="34">
      </td>
  </tr>
  <tr  class="b_text">
    <td  class="b_text">&nbsp;</td>

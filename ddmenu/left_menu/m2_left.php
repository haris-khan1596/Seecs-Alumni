                    ...
                    <td>
                        <div id="menu10">
                            <ul style="list-style: none; margin: 0; padding: 0;">
                                <li><a href="http://alumni.seecs.nust.edu.pk/ddmenu/m2_2.php">The Members</a></li>
                                <li ><a href="http://alumni.seecs.nust.edu.pk/ddmenu/m2_3.php">Commitment</a></li>
                                <li ><a href="http://alumni.seecs.nust.edu.pk/ddmenu/m2_4.php">Benefits</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>

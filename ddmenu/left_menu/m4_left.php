                    ...
                    <td>
                        <div id="menu10">
                            <ul style="list-style: none; margin: 0; padding: 0;">
                                <li><a href="http://alumni.seecs.nust.edu.pk/ddmenu/m4_2.php">Learn how to Give</a></li>
                                <li><a href="http://alumni.seecs.nust.edu.pk/ddmenu/how_program_works.php">How program works?</a></li>
                                <li><a href="http://alumni.seecs.nust.edu.pk/ddmenu/how_to_contribute.php">How To Contribute?</a></li>
                                <li><a href="http://alumni.seecs.nust.edu.pk/ddmenu/apply.php">Apply Now</a></li>
                               <!--
                                <li ><a href="http://alumni.seecs.nust.edu.pk/ddmenu/m4_4.php">Scholarship Criteria</a></li>
                                <li ><a href="http://alumni.seecs.nust.edu.pk/ddmenu/m4_5.php">Application Process</a></li>
                                <li ><a href="http://alumni.seecs.nust.edu.pk/ddmenu/m4_6.php">Award</a></li>
                                -->
                            </ul>
                        </div>
                    </td>

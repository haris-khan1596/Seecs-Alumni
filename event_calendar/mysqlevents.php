...
$dbpass="BingoBus"; // the password of your MySQL Server
$dbname="alumni"; // the name of your MySQL Database
$tblname="event_calendar"; // the name of your MySQL Database Table
$tblDateName="edate"; // the name of your MySQL Table Date Field
$tblContent="txt"; // the name of your MySQL Table Content Field
$tblLink="url"; // the name of your MySQL Table Link Field
/*
********************************************************************************
...
<html>
<head><title>NUST-SEECS Event Calendar</title>
...
********************************************************************************
*/
$cal->enableDatePicker(2002,2010); // this enables the month's datepicker (year range 2002 - 2006)

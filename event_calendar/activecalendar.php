...
********************************************************************************
*/
function activeCalendar($year=false,$month=false,$day=false,$GMTDiff="none"){
$this->timetoday=time();
$this->selectedday=-2;
...
return "<table border=1 class=\"".$this->cssMonthTable."\">\n";
}
/*
********************************************************************************
...
function mkMonthTitle(){
	if (!$this->monthNav){
		...
		$out="<tr bordercolor=white><td align=right colspan=2>";
		...
		$out.="<td align=left class=\"".$this->cssMonthNav."\" colspan=\"2\">";
...
function mkDatePicker($yearpicker=false){
	...
	if ($this->datePicker){
		$out="<tr bordercolor=white><td class=\"".$this->cssPicker."\" colspan=\"".$pickerSpan."\">\n";

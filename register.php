...
function validate()
	{
		...
		else if(document.getElementById("reg_user_chk").value!="<div class='marquee msgbox_ok'>Registration Number validated")
		{
...
?>
  ...
  <tr>
    ...
    <td align="left" valign="top"><table border="0" align="center" cellpadding="3" cellspacing="0" class="table_body">
      <tr>
        <td height="323" valign="top"><p>&nbsp;</p>
          <div class="msgbox_info">Alumni Membership Registration is currently closed for maintenance.         
            </div>
		</td>
      </tr>
    </table>  

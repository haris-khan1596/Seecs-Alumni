...
border-style:dotted; border-color:#666666; border-width:1px
    ...
    <body>
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="table_main">
            ...
            <tr>
                <td width="34" align="left" valign="top" class="table_left">
...
<tr >
                          ...
                          <td scope="col"><?php
                                                        ...
                                                        <tr >
                                                            <td width="20%" valign="top"><span class="b_text">Request For: *</span></td>
<td align="left" valign="top" class="b_text"><p>
                                                              <select name="cbonotice" class="b_text" id="cbonotice">
